...
export default function About() {
  ...
  return (
    <>
      <div className="min-h-screen bg-paper text-ink-soft font-sans selection:bg-clay selection:text-white overflow-hidden relative">

        {/* Decorative Background Ambient Glows */}
        <div className="absolute top-1/4 left-0 w-96 h-96 bg-clay/5 rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-sage/5 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 pt-28 pb-12 lg:pt-36 lg:pb-16 relative z-10">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center mb-6 lg:mb-8">
            ...
            <div className="lg:col-span-5 order-2 lg:order-1 flex flex-col items-center lg:items-start gap-4">
              ...
              <div className="relative group max-w-sm lg:max-w-none w-full aspect-[4/5]">
                <div className="absolute -inset-2 bg-gradient-to-tr from-clay/20 via-gold/10 to-sage/20 rounded-xl blur-md opacity-75 group-hover:opacity-100 transition duration-500" />

                <div className="relative w-full h-full bg-card border border-line rounded-xl overflow-hidden p-3 flex items-center justify-center">
                  <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-clay" />
                  <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-line-strong" />
                  <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-line-strong" />
                  <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-sage" />
              ...
              </div>{/* ← closes Image Wrapper Card */}

              {/* High-Attention Animated & Pulsating Secondary CTA Button */}
              <button
                onClick={() => setIsAuditModalOpen(true)}
                className="w-full max-w-sm lg:max-w-none flex items-center justify-between px-5 py-4 bg-card hover:bg-clay-tint text-ink hover:text-clay-deep border border-line-strong hover:border-clay rounded-xl transition-all duration-300 group/btn font-semibold text-sm tracking-wide shadow-[0_0_0_0_rgba(180,80,46,0.4)] animate-[pulse_3s_infinite] hover:animate-none hover:scale-[1.02]"
              >
                ...
                <svg
                  className="w-5 h-5 text-clay group-hover/btn:text-clay-deep transform group-hover/btn:translate-x-1.5 transition-transform duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              </button>{/* ← closes CTA Button */}

            </div>{/* ← closes lg:col-span-5 */}

            {/* Typography Stack (7 Columns) */}
            <div className="lg:col-span-7 order-1 lg:order-2 space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-card border border-line text-clay rounded-full text-xs font-semibold tracking-[0.16em] uppercase">
                <span className="w-1.5 h-1.5 rounded-full bg-clay animate-pulse" />
                Paid Media Specialist
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-semibold tracking-tight text-ink leading-[1.1] font-display">
                I Don't Just Buy Clicks.<br />
                <span className="italic font-medium text-clay">
                  I Engineer Profitable Acquisition Engines.
                </span>
              </h1>
              <p className="text-lg sm:text-xl text-ink-soft font-normal max-w-2xl leading-relaxed">
          ...
          </section>{/* ← closes Section 1: Hero */}

          {/* ============================================================= */}
          {/* 2. CORE PHILOSOPHY & NARRATIVE (The "Why")                     */}
          {/* ============================================================= */}
          <section className="mb-16 lg:mb-20 border-t border-line pt-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
              <div className="lg:col-span-4">
                <h2 className="text-xs uppercase tracking-[0.2em] text-taupe font-bold sticky top-8">
                  Core Philosophy
                </h2>
              </div>
              <div className="lg:col-span-8 space-y-6 text-base sm:text-lg text-ink-soft font-normal max-w-3xl leading-relaxed">
                <p>
                  I don't look at advertising as a creative playground; I treat it as a
                  <strong className="text-ink font-semibold"> capital deployment engine</strong>. I approach marketing as a holistic ecosystem strategist, engineering tailored, high-intent paid campaigns and optimized funnels that consistently maximize customer acquisition and conversion rates.
                </p>
                <p>
                  My work sits squarely at the intersection of revenue-driven growth strategy and collaborative team leadership. Whether I'm architecting scalable marketing systems, optimizing backend funnels to boost closing margins, or resolving advanced data tracking leaks, my objective is always a predictable, <strong className="text-sage-deep font-semibold">highly-profitable acquisition model</strong>.
                </p>
              </div>
            </div>
          </section>{/* ← closes Section 2: Core Philosophy */}
          ...
          <section className="mb-16 lg:mb-24">
            <div className="mb-8">
              <h2 className="text-xs uppercase tracking-[0.2em] text-taupe font-bold mb-2">
                Operational Framework
              </h2>
              <h3 className="text-2xl sm:text-3xl font-semibold font-display tracking-tight text-ink">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
              ...
              {/* Card 1 */}
              <div className="bg-card border border-line hover:border-clay/40 rounded-xl p-6 transition-all duration-300 group flex flex-col justify-between hover:shadow-[0_12px_40px_-16px_rgba(33,28,22,0.2)]">
                <div>
                  <div className="text-sm font-mono text-clay font-bold mb-4 flex items-center gap-2">
                    <span>01 / 📊 Tracking & Data Infrastructure</span>
                  </div>
                  <p className="text-ink-soft text-sm sm:text-base font-normal leading-relaxed">
                    Eliminating attribution gaps via <strong className="text-ink font-semibold">GTM</strong>, <strong className="text-ink font-semibold">GA4</strong>, <strong className="text-ink font-semibold">Meta Pixel</strong>, and <strong className="text-ink font-semibold">Conversions API (CAPI)</strong> to back every dollar with precise data.
                  </p>
                </div>
                <div className="w-full h-px bg-gradient-to-r from-clay/0 via-clay/30 to-clay/0 mt-6 group-hover:via-clay/60 transition-all duration-500" />
              </div>{/* ← closes Card 1 */}
              ...
              <div className="bg-card border border-line hover:border-clay/40 rounded-xl p-6 transition-all duration-300 group flex flex-col justify-between hover:shadow-[0_12px_40px_-16px_rgba(33,28,22,0.2)]">
                <div>
                  ...
                  <p className="text-ink-soft text-sm sm:text-base font-normal leading-relaxed">
                    Engineering aggressive market acquisition by deploying synchronized paid search <strong className="text-ink font-semibold">Google Ads</strong> and hyper-targeted audience funnels <strong className="text-ink font-semibold">Meta Ads</strong> designed for raw revenue generation.
                  </p>
                </div>
                <div className="w-full h-px bg-gradient-to-r from-clay/0 via-clay/30 to-clay/0 mt-6 group-hover:via-clay/60 transition-all duration-500" />
              </div>{/* ← closes Card 2 */}
              ...
              {/* Card 3 */}
              <div className="bg-card border border-line hover:border-sage/40 rounded-xl p-6 transition-all duration-300 group flex flex-col justify-between hover:shadow-[0_12px_40px_-16px_rgba(33,28,22,0.2)]">
                <div>
                  <div className="text-sm font-mono text-sage-deep font-bold mb-4 flex items-center gap-2">
                    <span>03 / 🛡️ Friction-less Ecosystem</span>
                  </div>
                  <p className="text-ink-soft text-sm sm:text-base font-normal leading-relaxed">
                    Providing elite <strong className="text-ink font-semibold">Conversion Rate Optimization (CRO)</strong> and landing page guidance to dismantle funnel leaks, maximize user intent, and squeeze peak profits out of your incoming traffic.
                  </p>
                </div>
                <div className="w-full h-px bg-gradient-to-r from-sage/0 via-sage/30 to-sage/0 mt-6 group-hover:via-sage/60 transition-all duration-500" />
              </div>{/* ← closes Card 3 */}

            </div>{/* ← closes 3-column grid */}
          </section>{/* ← closes Section 3: Methodology */}

          {/* ============================================================= */}
          {/* 4. CALL TO ACTION: THE LIVE SYSTEM AUDIT                       */}
          {/* ============================================================= */}
          <section className="relative rounded-2xl border border-ink bg-ink p-6 md:p-10 pb-10 md:pb-12 overflow-hidden">
          ...
          </section>{/* ← closes Section 4: Call to Action */}
      ...
      {/* Rendered as sibling to the page div, inside the root fragment  */}
      {/* ============================================================= */}
      {isAuditModalOpen && (
          ...
          <div className="relative w-full max-w-md p-6 rounded-xl border border-line bg-card text-center shadow-2xl space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              >
                ...
                Via WhatsApp
              </a>{/* ← closes WhatsApp Channel */}

            </div>{/* ← closes Channel Buttons row */}
          </div>{/* ← closes modal inner card */}
        </div>
      )}{/* ← closes isAuditModalOpen conditional */}

    </>
  );
} // closes About() component